...
if os.path.exists("./quaterly_db"):
    shutil.rmtree("./quaterly_db")
...
mongo_cm = MongoDBSaver.from_conn_string(
    conn_string=MONGO_URI,
    db_name="workflow_checkpoints",
    collection_name="banking_analysis")

mongo_saver = mongo_cm.__enter__()

app = workflow.compile(checkpointer=mongo_saver)
